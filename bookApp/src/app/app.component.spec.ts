...
describe('AppComponent', () => {
  ...
  let service = TestBed.get(BookService);
  let  booksUrl = 'http://henri-potier.xebia.fr/books';

    it('should return books data', () => {
      service.getBooks().subscribe((data) =>{
        expect(data).toEqual(BooksData);
      })

      const req = httpMock.expectOne({method: 'GET', url: 'http://henri-potier.xebia.fr/books'});;
